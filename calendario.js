(function () {
    ...
    const T = {
        ...
        nav: { tiempo: 'Navidad', color: '#8b5e0a', icono: '⭐', p: '/f/fiesta-de-navidad/' },
    ...
    const SOLEM = {
        ...
        '1-6':  { n: 'Epifanía del Señor',                    i: '⭐', p: '/s/solemnidad-de-la-epifania/' },
        ...
        '6-29': { n: 'Santos Pedro y Pablo',                  i: '⚓', p: '/s/san-pedro-apostol/' },
        '7-16': { n: 'Nuestra Señora del Carmen',             i: '🌹', p: '/n/nuestra-senora-del-monte-carmelo/' },
        ...
        '8-22': { n: 'Memoria de la Virgen María Reina',     i: '👑', p: '/m/memoria-de-la-virgen-maria-reina/' },
        '9-8':  { n: 'Natividad de la Virgen María',          i: '🌸', p: '/f/fiesta-de-la-natividad-de-la-virgen-maria/' },
        '9-14': { n: 'Exaltación de la Santa Cruz',           i: '✝️', p: '/f/fiesta-de-la-exaltacion-de-la-santa-cruz/' },
        '10-7': { n: 'Nuestra Señora del Rosario',            i: '📿', p: '/s/santo-rosario/' },
        '10-12': { n: 'Nuestra Señora del Pilar',             i: '🌹', p: '/n/nuestra-senora-del-pilar/' },
        '11-1': { n: 'Todos los Santos',                      i: '😇', p: '/s/solemnidad-de-todos-los-santos/' },
        '11-2': { n: 'Fieles Difuntos',                       i: '🕯️', p: '/p/purgatorio/' },
        '11-21':{ n: 'Presentación de la Virgen María en el templo',                 i: '🕯️', p: '/p/presentacion-de-la-virgen-maria-en-el-templo/' },
        ...
        '12-25':{ n: 'Natividad del Señor',                   i: '⭐', p: '/f/fiesta-de-navidad/' }
    };

    const SAINTS = {
        "1-1":  [{ n: "San Guillermo de Saint‑Benignus", p: "/s/san-guillermo-de-saint-benignus/" }, { n: "San Odilo de Cluny", p: "/s/san-odilo-de-cluny/" }],
        "1-2":  [{ n: "San Basilio de Cesarea", p: "/s/san-basilio-de-cesarea/" }, { n: "San Gregorio Nacianceno", p: "/s/san-gregorio-nacianceno/" }],
        "1-3":  [{ n: "Santa Genoveva", p: "/s/santa-genoveva-de-paris/" }],
        ...
        "1-7":  [{ n: "San Raimundo de Peñafort", p: "/s/san-raimundo-de-penafort/" }],
        "1-8": [{ n: "San Lorenzo Justiniano", p: "/s/san-lorenzo-justiniano/" }],
        ...
        "1-13": [{ n: "San Hilario de Poitiers", p: "/s/san-hilario-de-poitiers/" }],
        "1-14": [{ n: "San Félix de Nola", p: "/s/san-felix-de-nola/" }],
        "1-15": [{ n: "San Arnold Janssen", p: "/s/san-arnold-janssen/" }, { n: "San Mauro", p: "/s/san-mauro/" }],
        
                "1-16": [{ n: "Papa Marcelo I", p: "/p/papa-marcelo-i/" }],
"1-17": [{ n: "San Antonio Abad", p: "/s/san-antonio-abad/" }],
        ...
        "1-20": [{ n: "Papa Fabián", p: "/p/papa-fabian/" }, { n: "San Sebastián", p: "/s/san-sebastian/" }, { n: "San Fructuoso de Tarragona", p: "/s/san-fructuoso/" }],
        "1-21": [{ n: "Santa Inés", p: "/s/santa-ines/" }],
        "1-22": [{ n: "San Vicente Mártir", p: "/s/san-vicente-martir/" }, { n: "Santos Vicente y Anastasio", p: "/s/santos-vicente-y-anastasio/" }],
        ...
        "1-26": [{ n: "San Timoteo", p: "/s/san-timoteo/" }, { n: "San Tito", p: "/s/san-tito/" }],
        "1-27": [{ n: "Santa Ángela de Merici", p: "/s/santa-angela-de-merici/" }],
        "1-28": [{ n: "Santo Tomás de Aquino", p: "/s/santo-tomas-de-aquino/" }],
        "1-29": [{ n: "San Valero", p: "/s/san-valero/" }],
        "1-30": [{ n: "Papa Félix IV (III)", p: "/p/papa-felix-iv-iii/" }, { n: "Santa Jacinta Mariscotti", p: "/s/santa-jacinta-mariscotti/" }],
        ...
        "2-4":  [{ n: "Santa Juana de Valois", p: "/s/santa-juana-de-valois/" }, { n: "San José de Leonisa", p: "/s/san-jose-de-leonisa/" }],
        "2-5":  [{ n: "Santa Águeda", p: "/s/santa-agueda/" }, { n: "San Avito", p: "/s/san-avito/" }],
        "2-6":  [{ n: "Santa Dorotea", p: "/s/santa-dorotea/" }, { n: "San Pablo Miki y compañeros", p: "/s/san-pablo-miki-y-companeros/" }],
        "2-8":  [{ n: "San Jerónimo Emiliani", p: "/s/san-jeronimo-emiliani/" }, { n: "Santa Josefina Bakhita", p: "/s/santa-josefina-bakhita/" }],
        ...
        "2-22": [{ n: "Cátedra de San Pedro", p: "/f/fiesta-de-la-catedra-de-san-pedro/" }, { n: "San Pedro Apóstol", p: "/s/san-pedro-apostol/" }],
        "2-23": [{ n: "San Policarpo", p: "/s/san-policarpo/" }, { n: "Beato Pedro Frelichowski", p: "/b/beato-pedro-frelichowski/" }],
        ...
        "3-1":  [{ n: "San David", p: "/s/san-david/" }, { n: "Papa Félix III (II)", p: "/p/papa-felix-iii-ii/" }, { n: "San Albino de Angers", p: "/s/san-albino-de-angers/" }],
        "3-2":  [{ n: "Santa Inés de Bohemia", p: "/s/santa-ines-de-bohemia/" }],
        "3-3":  [{ n: "Santa Katharine Drexel", p: "/s/santa-katherine-drexel/" }, { n: "Santos Emeterio y Celedonio", p: "/s/santos-emeterio-y-celedonio/" }],
        "3-4":  [{ n: "San Casimiro", p: "/s/san-casimiro/" }],
        "3-5":  [{ n: "San Juan José de la Cruz", p: "/s/san-juan-jose-de-la-cruz/" }, { n: "Papa Lucio I", p: "/p/papa-lucio-i/" }],
        "3-6":  [{ n: "San Olegario", p: "/s/san-olegario/" }, { n: "San Julián de Toledo", p: "/s/san-julian-de-toledo/" }],
        "3-7":  [{ n: "Santa Felicidad", p: "/s/santa-felicidad/" }, { n: "Santa Perpetua", p: "/s/santa-perpetua/" }, { n: "San Pablo el Simple", p: "/s/san-pablo-el-simple/" }],
        "3-8":  [{ n: "San Juan de Dios", p: "/s/san-juan-de-dios/" }],
        "3-9":  [{ n: "Santa Francisca Romana", p: "/s/santa-francisca-romana/" }],
        "3-10": [{ n: "San Juan Olgivie", p: "/s/san-juan-olgivie/" }],
        "3-12": [{ n: "San Teófano", p: "/s/san-teofano/" }],
        "3-13": [{ n: "Santa Eufrasia", p: "/s/santa-eufrasia/" }],
        "3-15": [{ n: "San Clemente María Hofbauer", p: "/s/san-clemente-maria-hofbauer/" }, { n: "Santa Luisa de Marillac", p: "/s/santa-luisa-de-marillac/" }],
        "3-16": [{ n: "San Julián de Anazarbus", p: "/s/san-julian-de-anazarbus/" }],
        "3-17": [{ n: "San Patricio de Irlanda", p: "/s/san-patricio-de-irlanda/" }, { n: "Santa Gertrudis de Nivelles", p: "/s/santa-gertrudis-de-nivelles/" }],
        "3-18": [{ n: "San Eduardo", p: "/s/san-eduardo/" }, { n: "San Cirilo de Jerusalén", p: "/s/san-cirilo-de-jerusalen/" }, { n: "San Anselmo de Lucca", p: "/s/san-anselmo-de-lucca/" }],
        ...
        "3-24": [{ n: "San Óscar Romero", p: "/s/san-oscar-romero/" }, { n: "Santa Catalina de Suecia", p: "/s/santa-catalina-de-suecia/" }],
        ...
        "4-7":  [{ n: "San Juan Bautista de la Salle", p: "/s/san-juan-bautista-de-la-salle/" }, { n: "San Enrique Walpole", p: "/s/san-enrique-walpole/" }],
        "4-8":  [{ n: "Santa Julie Billiart", p: "/s/santa-julie-billiart/" }],
        "4-9":  [{ n: "Santa Valdetrudes", p: "/s/santa-valdetrudes/" }],
        "4-11": [{ n: "San Estanislao", p: "/s/san-estanislao/" }],
        "4-13": [{ n: "San Hermenegildo", p: "/s/san-hermenegildo/" }, { n: "Papa Martín I", p: "/p/papa-martin-i/" }],
        ...
        "4-24": [{ n: "San Fidelis de Sigmaringen", p: "/s/san-fidelis-de-sigmaringen/" }],
        ...
        "4-28": [{ n: "San Pedro Chanel", p: "/s/san-pedro-chanel/" }, { n: "San Luis Grignion de Montfort", p: "/s/san-luis-maria-grignion-de-montfort/" }],
        "4-29": [{ n: "Santa Endelienta", p: "/s/santa-endelienta/" }, { n: "Santa Catalina de Siena", p: "/s/santa-catalina-de-siena/" }, { n: "San Pedro mártir", p: "/s/san-pedro-martir/" }],
        "4-30": [{ n: "Papa Pío V", p: "/p/papa-pio-v/" }],
        "5-1":  [{ n: "San José Obrero", p: "/s/san-jose-obrero/" }, { n: "San Torcuato", p: "/s/san-torcuato/" }],
        "5-2":  [{ n: "San Atanasio de Alejandría", p: "/s/san-atanasio-de-alejandria/" }, { n: "San Antonino de Florencia", p: "/s/san-antonino-de-florencia/" }],
        ...
        "5-8":  [{ n: "San Desiderio", p: "/s/san-desiderio/" }, { n: "Papa Bonifacio IV", p: "/p/papa-bonifacio-iv/" }],
        ...
        "5-17": [{ n: "San Pascual Baylón", p: "/s/san-pascual-baylon/" }],
        "5-18": [{ n: "San Félix de Cantalicio", p: "/s/san-felix-de-cantalicio/" }],
        "5-19": [{ n: "Papa Celestino V", p: "/p/papa-celestino-v/" }, { n: "San Francisco Coll", p: "/s/san-francisco-coll/" }],
        ...
        "5-24": [{ n: "María Auxiliadora", p: "/m/maria-auxilio-de-los-cristianos/" }],
        "5-25": [{ n: "San Beda el Venerable", p: "/b/beda-el-venerable/" }, { n: "Papa Gregorio VII", p: "/p/papa-gregorio-vii/" }],
        "5-26": [{ n: "San Matías Maulumba Kalemba", p: "/s/san-matias-maulumba-kalemba/" }, { n: "San Felipe Neri", p: "/s/san-felipe-neri/" }, { n: "Santa Mariana de Jesús Paredes", p: "/s/santa-mariana-de-jesus-paredes/" }],
        "5-27": [{ n: "San Agustín de Canterbury", p: "/s/san-agustin-de-canterbury/" }],
        "5-29": [{ n: "San Maximino de Tréveris", p: "/s/san-maximino-de-treveris/" }],
        "5-30": [{ n: "Santa Juana de Arco", p: "/s/santa-juana-de-arco/" }, { n: "Papa Félix I", p: "/p/papa-felix-i/" }, { n: "San Fernando III", p: "/s/san-fernando-iii-el-santo/" }],
        "5-31": [{ n: "Visitación de la Bienaventurada Virgen María", p: "/f/fiesta-de-la-visitacion-de-la-bienaventurada-virgen-maria/" }],
        "6-1":  [{ n: "San Justino Mártir", p: "/s/san-justino-martir/" }],
        ...
        "6-6":  [{ n: "San Norberto", p: "/s/san-norberto/" }],
        ...
        "6-9":  [{ n: "San Efrén de Siria", p: "/s/san-efren-de-siria/" }],
        ...
        "6-15": [{ n: "San Bernardo de Menthon", p: "/s/san-bernardo-de-menthon/" }, { n: "Santa María Micaela del Santísimo Sacramento", p: "/s/santa-maria-micaela-del-santisimo-sacramento/" }],
        ...
        "6-20": [{ n: "Papa Silverio", p: "/p/papa-silverio/" }, { n: "San Adalberto de Magdeburgo", p: "/s/san-adalberto-de-magdeburgo/" }],
        "6-21": [{ n: "San Luis Gonzaga", p: "/s/san-luis-gonzaga/" }],
        ...
        "6-27": [{ n: "San Cirilo de Alejandría", p: "/s/san-cirilo-de-alejandria/" }, { n: "San Ladislao de Hungría", p: "/s/san-ladislao-de-hungria/" }],
        ...
        "6-29": [{ n: "San Pedro Apóstol", p: "/s/san-pedro-apostol/" }, { n: "San Pablo Apóstol", p: "/s/san-pablo-apostol/" }, { n: "Santa Ema", p: "/s/santa-ema/" }],
        "6-30": [{ n: "Santos Protomártires de Roma", p: "/s/santos-protomartires-de-roma/" }, { n: "San Otón de Bamberg", p: "/s/san-oton-de-bamberg/" }, { n: "Primeros Mártires de la Iglesia de Roma", p: "/p/primeros-martires-de-la-iglesia-de-roma/" }],
        ...
        "7-4":  [{ n: "San Pier Giorgio Frassati", p: "/s/san-pier-giorgio-frassati/" }, { n: "Santa Isabel I de Portugal", p: "/s/santa-isabel-i-de-portugal/" }],
        "7-5":  [{ n: "San Antonio María Zaccaría", p: "/s/san-antonio-maria-zaccaria/" }, { n: "San Guillermo de Hirschau", p: "/s/san-guillermo-abad-de-hirschau/" }],
        "7-6":  [{ n: "Santa María Goretti", p: "/s/santa-maria-goretti/" }, { n: "San Rómulo de Fiesole", p: "/s/san-romulo-de-fiesole/" }],
        "7-7":  [{ n: "Papa Benedicto XI", p: "/p/papa-benedicto-xi/" }, { n: "San Panteno", p: "/s/san-panteno/" }],
        ...
        "7-14": [{ n: "San Camilo de Lelis", p: "/s/san-camilo-de-lelis/" }, { n: "San Francisco Solano", p: "/s/san-francisco-solano/" }],
        ...
        "7-22": [{ n: "Santa María Magdalena", p: "/s/santa-maria-magdalena/" }],
        "7-23": [{ n: "Ezequiel", p: "/e/ezequiel-profeta/" }],
        "7-24": [{ n: "San Charbel Makhluf", p: "/s/san-charbel-makhlouf/" }, { n: "San Juan Boste", p: "/s/san-juan-boste/" }, { n: "Santa Luisa de Saboya", p: "/s/santa-luisa-de-saboya/" }],
        ...
        "7-28": [{ n: "Papa Víctor I", p: "/p/papa-victor-i/" }, { n: "Santos Nazario y Celso", p: "/s/santos-nazario-celso-y-victor-i/" }],
        "7-29": [{ n: "Santa Marta", p: "/s/santa-marta/" }],
        ...
        "8-1":  [{ n: "San Alfonso María de Ligorio", p: "/s/san-alfonso-maria-de-ligorio/" }],
        ...
        "8-7":  [{ n: "San Cayetano", p: "/s/san-cayetano/" }, { n: "Papa Sixto II", p: "/p/papa-sixto-ii/" }, { n: "San Alberto de Trapani", p: "/s/san-alberto-de-trapani/" }],
        "8-8":  [{ n: "Santo Domingo de Guzmán", p: "/s/santo-domingo-de-guzman/" }, { n: "Catorce Santos Auxiliares", p: "/c/catorce-santos-auxiliares/" }],
        "8-9":  [{ n: "Santa Teresa Benedicta de la Cruz", p: "/s/santa-teresa-benedicta-de-la-cruz-edith-stein/" }, { n: "San Juan de Alvernia", p: "/s/san-juan-de-alvernia/" }],
        "8-10": [{ n: "San Lorenzo", p: "/s/san-lorenzo/" }],
        "8-11": [{ n: "Santa Clara de Asís", p: "/s/santa-clara-de-asis/" }],
        "8-12": [{ n: "Santa Juana Francisca de Chantal", p: "/s/santa-juana-francisca-de-chantal/" }, { n: "Santa Hilaria y compañeras", p: "/s/santa-hilaria-y-companeras/" }, { n: "San Euplusio", p: "/s/san-euplusio/" }],
        "8-13": [{ n: "Papa Ponciano", p: "/p/papa-ponciano/" }, { n: "San Juan Berchmans", p: "/s/san-juan-berchmans/" }, { n: "Santa Radegunda", p: "/s/santa-radegunda/" }],
        "8-14": [{ n: "San Maximiliano María Kolbe", p: "/s/san-maximiliano-maria-kolbe/" }, { n: "Milagro eucarístico de Florencia", p: "/m/milagro-eucaristico-de-florencia-italia/" }],
        ...
        "8-17": [{ n: "Santa Beatriz de Silva", p: "/s/santa-beatriz-de-silva/" }, { n: "Santa Clara de Montefalco", p: "/s/santa-clara-de-montefalco/" }],
        ...
        "8-19": [{ n: "San Luis de Toulouse", p: "/s/san-luis-obispo/" }, { n: "San Juan Eudes", p: "/s/san-juan-eudes/" }, { n: "Papa Sixto III", p: "/p/papa-sixto-iii/" }, { n: "Beato Ezequiel Moreno", p: "/e/ezequiel-moreno/" }],
        "8-20": [{ n: "San Bernardo de Claraval", p: "/s/san-bernardo-de-claraval/" }, { n: "Samuel", p: "/p/profeta-samuel/" }],
        "8-21": [{ n: "Papa Pío X", p: "/p/papa-pio-x/" }, { n: "San Privato", p: "/s/san-privato/" }],
        "8-23": [{ n: "Santa Rosa de Lima", p: "/s/santa-rosa-de-lima/" }],
        "8-24": [{ n: "San Bartolomé", p: "/s/san-bartolome/" }],
        "8-25": [{ n: "San Luis IX de Francia", p: "/s/san-luis-ix-de-francia/" }, { n: "San José de Calasanz", p: "/s/san-jose-de-calasanz/" }],
        ...
        "8-27": [{ n: "San Cesáreo de Arlés", p: "/c/cesar-de-arles/" }, { n: "Santa Mónica", p: "/s/santa-monica/" }],
        "8-28": [{ n: "San Agustín de Hipona", p: "/s/san-agustin-de-hipona/" }],
        "8-29": [{ n: "Nuestra Señora de Atocha", p: "/n/nuestra-senora-de-atocha/" }],
        "8-31": [{ n: "San Raimundo Nonato", p: "/s/san-raimundo-nonato/" }, { n: "San Paulino de Tréveris", p: "/s/san-paulino-de-treveris/" }],
        ...
        "9-6":  [{ n: "San Magno", p: "/s/san-magno/" }],
                "9-7": [{ n: "Santa Regina", p: "/s/santa-regina/" }],
"9-8":  [{ n: "Virgen de Covadonga", p: "/v/virgen-de-covadonga/" }],
        ...
        "9-15": [{ n: "María Santísima del Mayor Dolor", p: "/m/maria-santisima-del-mayor-dolor/" }, { n: "Santa Catalina de Génova", p: "/s/santa-catalina-de-genova/" }, { n: "San Pedro de Arbués", p: "/s/san-pedro-de-arbues/" }],
        "9-16": [{ n: "San Juan Macías", p: "/s/san-juan-macias/" }, { n: "Papa Cornelio", p: "/p/papa-cornelio/" }],
        "9-17": [{ n: "San Roberto Belarmino", p: "/s/san-roberto-belarmino/" }, { n: "Estigmas de San Francisco", p: "/e/estigmas-de-san-francisco-de-asis/" }],
                "9-18": [{ n: "San José de Cupertino", p: "/s/san-jose-de-cupertino/" }],
"9-19": [{ n: "San Jenaro", p: "/s/san-jenaro/" }],
        "9-20": [{ n: "San Andrés Kim Taegon", p: "/s/san-andres-kim-taegon/" }],
        "9-21": [{ n: "San Mateo Evangelista", p: "/s/san-mateo-evangelista/" }],
        "9-22": [{ n: "San Mauricio", p: "/s/san-mauricio/" }],
        "9-23": [{ n: "San Pío de Pietrelcina", p: "/s/san-pio-de-pietrelcina/" }],
                "9-24": [{ n: "Nuestra Señora de las Mercedes", p: "/n/nuestra-senora-de-las-mercedes/" }],
"9-25": [{ n: "San Cleofás", p: "/s/san-cleofas/" }],
        "9-26": [{ n: "San Cosme y San Damián", p: "/s/san-cosme-y-san-damian/" }],
        "9-27": [{ n: "San Vicente de Paúl", p: "/s/san-vicente-de-paul/" }],
        "9-28": [{ n: "San Venceslao", p: "/s/san-venceslao/" }, { n: "San Lorenzo Ruiz", p: "/s/san-lorenzo-ruiz/" }],
        ...
        "9-30": [{ n: "San Jerónimo de Estridón", p: "/s/san-jeronimo-de-estridon/" }],
        "10-1": [{ n: "Santa Teresa del Niño Jesús y de la Santa Faz", p: "/s/santa-teresa-del-nino-jesus-y-de-la-santa-faz/" }],
        "10-2": [{ n: "Ángel de la Guarda", p: "/a/angel-de-la-guarda/" }, { n: "Santo Tomás Ereford", p: "/s/santo-tomas-ereford/" }],
        ...
        "10-10":[{ n: "San Paulino de York", p: "/s/san-paulino-de-york/" }, { n: "Santo Tomás de Villanueva", p: "/s/santo-tomas-de-villanueva/" }],
        "10-11":[{ n: "Papa Juan XXIII", p: "/p/papa-juan-xxiii/" }, { n: "Santa María Soledad Torres Acosta", p: "/m/maria-soledad-torres-acosta/" }],
        ...
        "10-14":[{ n: "Papa Calixto I", p: "/p/papa-calixto-i/" }],
        "10-15":[{ n: "Santa Teresa de Jesús", p: "/s/santa-teresa-de-avila/" }],
        ...
        "10-19":[{ n: "San Pedro de Alcántara", p: "/s/san-pedro-de-alcantara/" }, { n: "San Juan de Brébeuf", p: "/s/san-juan-de-brebeuf/" }, { n: "San Isaac Jogues", p: "/s/san-isaac-jogues/" }],
                "10-20": [{ n: "San Juan de Kanty", p: "/s/san-juan-de-kanty/" }],
        "10-21": [{ n: "Santa Úrsula", p: "/s/santa-ursula/" }, { n: "San Hilarión", p: "/s/san-hilarion/" }],
"10-22":[{ n: "Papa Juan Pablo II", p: "/p/papa-juan-pablo-ii/" }],
        ...
        "10-25":[{ n: "San Antonio de Sant'Ana Galvão", p: "/s/san-antonio-de-sant-ana-galvao/" }],
                "10-26": [{ n: "Papa Evaristo", p: "/p/papa-evaristo/" }],
"10-28":[{ n: "San Simón Apóstol", p: "/s/san-simon-zelote/" }, { n: "San Judas Tadeo", p: "/s/san-judas-tadeo/" }],
        ...
        "11-6": [{ n: "San Pedro Poveda", p: "/p/pedro-poveda/" }],
                "11-7": [{ n: "San Willibrord", p: "/s/san-willibrord/" }],
"11-9": [{ n: "Dedicación de la Basílica de Letrán", p: "/b/basilica-de-san-juan-de-letran/" }],
        "11-10":[{ n: "San León I Magno", p: "/s/san-leon-i-magno/" }],
        ...
        "11-19":[{ n: "Santa Mechtilde de Hackeborn", p: "/s/santa-mechtilde/" }],
        "11-20":[{ n: "San Edmundo rey mártir", p: "/s/san-edmundo-rey-martir/" }],
        "11-22":[{ n: "Santa Cecilia", p: "/s/santa-cecilia/" }],
        "11-23":[{ n: "Papa Clemente I", p: "/p/papa-clemente-i/" }, { n: "San Columbano", p: "/s/san-columbano/" }],
        "11-24":[{ n: "San Andrés Dung-Lac y compañeros", p: "/s/san-andres-dung-lac/" }, { n: "Santa Flora", p: "/s/santa-flora/" }],
        ...
        "11-27":[{ n: "Nuestra Señora de la Medalla Milagrosa", p: "/n/nuestra-senora-de-las-gracias-de-la-medalla-milagrosa/" }],
        ...
        "12-4": [{ n: "San Juan Damasceno", p: "/s/san-juan-damasceno/" }],
                "12-5": [{ n: "San Sabas", p: "/s/san-sabas/" }],
"12-6": [{ n: "San Nicolás", p: "/p/papa-noel-san-nicolas/" }, { n: "San Pedro Pascual", p: "/s/san-pedro-pascual/" }],
        "12-7": [{ n: "San Ambrosio de Milán", p: "/s/san-ambrosio-de-milan/" }],
        "12-8": [{ n: "Nuestra Señora de la Inmaculada Pureza", p: "/n/nuestra-senora-de-la-inmaculada-pureza/" }, { n: "Nuestra Señora de Andacollo", p: "/n/nuestra-senora-de-andacollo/" }, { n: "Santa Narcisa de Jesús", p: "/s/santa-narcisa-de-jesus/" }, { n: "Purísima Virgen de Cotoca", p: "/p/purisima-virgen-de-cotoca/" }],
        ...
        "12-21":[{ n: "San Pedro Canisio", p: "/s/san-pedro-canisio/" }],
                "12-23": [{ n: "San Juan de Kanty", p: "/s/san-juan-de-kanty/" }],
    ...
    function ydata(y) {
        ...
        return _yc[y] = {
            ...
            mov: [
                ...
                [addDays(ashWed, 25),{ fiesta: 'Domingo Laetare',       ...T.cua, color: '#e11d48', icono: '🌹', p: '/d/domingo-de-letare-laetare/' }],
