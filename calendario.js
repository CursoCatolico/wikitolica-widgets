(function () {
    ...
    const SAINTS = {
        ...
        "2-7": [{ n: "San Romualdo", p: "/s/san-romualdo/" }],
        "2-8": [{ n: "San Jerónimo Emiliani", p: "/s/san-jeronimo-emiliani/" }],
        "2-10": [{ n: "Santa Escolástica", p: "/s/santa-escolastica/" }],
        "2-12": [{ n: "Santa Eulalia", p: "/s/santa-eulalia/" }],
        "2-14": [{ n: "San Valentín", p: "/s/san-valentin/" }],
        ...
        "2-22": [{ n: "San Simón Pedro", p: "/s/san-simon-pedro/" }],
        ...
        "3-4": [{ n: "Lucio I", p: "/p/papa-lucio-i/" }],
        ...
        "3-16": [{ n: "Juan de Brébeuf", p: "/s/san-juan-de-brebeuf/" }],
        "3-17": [{ n: "San Patricio", p: "/s/san-patricio/" }],
        "3-18": [{ n: "San Eduardo", p: "/s/san-eduardo/" }],
        ...
        "4-14": [{ n: "Justino Mártir", p: "/s/san-justino-martir/" }],
        ...
        "4-29": [{ n: "Santa Endelienta", p: "/s/santa-endelienta/" }, { n: "San Pedro mártir", p: "/s/san-pedro-martir/" }],
        "5-1": [{ n: "San José Obrero", p: "/s/san-jose/" }],
        "5-2": [{ n: "San Atanasio", p: "/s/san-atanasio/" }],
        "5-3": [{ n: "Cruz de Caravaca", p: "/c/cruz-de-caravaca/" }],
        "5-5": [{ n: "Pío V", p: "/p/papa-pio-v/" }],
        "5-13": [{ n: "Nuestra Señora de Fátima", p: "/n/nuestra-senora-de-fatima/" }],
        "5-14": [{ n: "San Matías", p: "/s/san-matias-apostol/" }],
        "5-15": [{ n: "Juan Bautista de la Salle", p: "/s/san-juan-bautista-de-la-salle/" }],
        ...
        "5-26": [{ n: "Matías Maulumba Kalemba", p: "/s/san-matias-maulumba-kalemba/" }],
        ...
        "5-31": [{ n: "San Juan de Ávila", p: "/s/san-juan-de-avila/" }, { n: "Ángela de Mérici", p: "/s/santa-angela-de-merici/" }],
        ...
        "6-19": [{ n: "San Protasio", p: "/s/san-protasio/" }],
        ...
        "7-4": [{ n: "Pier Giorgio Frassati", p: "/s/san-pier-giorgio-frassati/" }],
        "7-5": [{ n: "Antonio María Zaccaría", p: "/s/san-antonio-maria-zaccaria/" }],
        "7-7": [{ n: "Benedicto XI", p: "/p/papa-benedicto-xi/" }],
        "7-8": [{ n: "Isabel de Portugal", p: "/s/santa-isabel-de-portugal/" }, { n: "San Kilian", p: "/s/san-kilian/" }],
        ...
        "8-2": [{ n: "San Pedro Julián Eymard", p: "/s/san-pedro-julian-eymard/" }],
        "8-4": [{ n: "San Juan María Vianney", p: "/s/san-juan-maria-vianney/" }],
        "8-6": [{ n: "Nuestra Señora de Copacabana", p: "/n/nuestra-senora-de-copacabana/" }, { n: "San Sixto II", p: "/s/san-sixto-ii/" }, { n: "Moisés", p: "/m/moises/" }],
        "8-7": [{ n: "San Cayetano", p: "/s/san-cayetano/" }],
        ...
        "8-16": [{ n: "San Roque", p: "/s/san-roque/" }],
        "8-17": [{ n: "Beatriz de Silva", p: "/s/santa-beatriz-de-silva/" }],
        "8-18": [{ n: "Santa Elena", p: "/s/santa-elena/" }],
        "8-19": [{ n: "San Luis de Toulouse", p: "/s/san-luis-obispo/" }],
        "8-20": [{ n: "San Bernardo de Clairvaux", p: "/s/san-bernardo-de-clairvaux/" }, { n: "San Esteban de Hungría", p: "/s/san-esteban-de-hungria/" }],
        "8-23": [{ n: "Santa Rosa de Lima", p: "/s/santa-rosa-de-lima/" }],
        "8-24": [{ n: "San Bartolomé", p: "/s/san-bartolome/" }],
        "8-25": [{ n: "San Luis de Francia", p: "/s/san-luis-de-francia/" }, { n: "María Micaela del Santísimo Sacramento", p: "/s/santa-maria-micaela-del-santisimo-sacramento/" }],
        "8-26": [{ n: "Virgen de Czestochowa", p: "/m/milagro-de-la-virgen-de-czestochowa-polonia/" }],
        "8-27": [{ n: "San José de Calasanz", p: "/s/san-jose-de-calasanz/" }, { n: "César de Arlés", p: "/c/cesar-de-arles/" }, { n: "Mónica", p: "/s/santa-monica/" }],
        ...
        "9-17": [{ n: "Estigmas de San Francisco de Asís", p: "/e/estigmas-de-san-francisco-de-asis/" }, { n: "Hildegarda de Bingen", p: "/s/santa-hildegarda-de-bingen/" }],
        ...
        "9-26": [{ n: "San Cosme", p: "/s/san-cosme/" }],
        "9-27": [{ n: "San Damián", p: "/s/san-damian/" }],
        "9-28": [{ n: "San Venceslao", p: "/s/san-venceslao/" }],
        ...
        "10-28": [{ n: "San Simón el Zelote", p: "/s/san-simon-zelote/" }],
        ...
        "11-9": [{ n: "San Teodoro", p: "/s/san-teodoro/" }],
        ...
        "11-16": [{ n: "Margarita de Escocia", p: "/s/santa-margarita-de-escocia/" }],
        ...
        "11-23": [{ n: "San Clemente I", p: "/s/san-clemente-i/" }],
        ...
        "12-2": [{ n: "San Pedro Crisólogo", p: "/s/san-pedro-crisologo/" }],
        ...
        "12-16": [{ n: "San Eusebio de Vercelli", p: "/s/san-eusebio-de-vercelli/" }],
        "12-26": [{ n: "San Esteban", p: "/s/san-esteban/" }],
        "12-28": [{ n: "Samuel", p: "/s/samuel-profeta/" }],
        "12-29": [{ n: "Tomás Becket", p: "/s/santo-tomas-becket/" }],
        "12-30": [{ n: "Virgen de la Nube", p: "/v/virgen-de-la-nube/" }],
        "12-31": [{ n: "Lorenzo Ruiz", p: "/s/san-lorenzo-ruiz/" }]
    };
