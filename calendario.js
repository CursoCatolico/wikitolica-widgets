(function () {
    ...
    const SAINTS = {
        ...
        "1-9":  [{ n: "Santa Paulina Jaricot", p: "/s/santa-paulina-jaricot/" }],
        ...
        "1-15": [{ n: "Arnold Janssen", p: "/s/san-arnold-janssen/" }, { n: "San Macario el Viejo", p: "/s/san-macario-el-viejo/" }, { n: "San Mauro", p: "/s/san-mauro/" }],
        ...
        "1-19": [{ n: "San Odilo de Cluny", p: "/s/san-odilo-de-cluny/" }, { n: "Santos Mario y Compañeros", p: "/s/santos-mario-y-companeros/" }],
        ...
        "2-15": [{ n: "San Claudio de La Colombière", p: "/s/san-claudio-de-la-colombiere/" }],
        "2-16": [{ n: "San Onésimo", p: "/s/san-onesimo/" }],
        ...
        "2-25": [{ n: "San Avertano", p: "/s/san-avertano/" }],
        "2-26": [{ n: "San Néstor", p: "/s/san-nestor/" }],
        ...
        "3-5":  [{ n: "San Juan José de la Cruz", p: "/s/san-juan-jose-de-la-cruz/" }],
        ...
        "3-28": [{ n: "Sixto III", p: "/p/papa-sixto-iii/" }, { n: "San Gontrán", p: "/s/san-gontran/" }, { n: "San Cirilo de Heliópolis", p: "/s/san-cirilo-de-heliopolis/" }],
        ...
        "4-6":  [{ n: "San Marcelino de Cartago", p: "/s/san-marcelino-de-cartago/" }],
        ...
        "4-26": [{ n: "San Marcelino", p: "/s/san-marcelino/" }, { n: "Nuestra Señora del Buen Consejo de Genazzano", p: "/n/nuestra-senora-del-buen-consejo-de-genazzano/" }],
        ...
        "5-6":  [{ n: "San Juan en la Puerta Latina", p: "/s/san-juan-en-la-puerta-latina/" }],
        "5-7":  [{ n: "San Juan de Beverly", p: "/s/san-juan-de-beverly/" }],
        "5-8":  [{ n: "San Pedro de Tarantesia", p: "/s/san-pedro-de-tarantesia/" }, { n: "San Desiderio", p: "/s/san-desiderio/" }],
        "5-10": [{ n: "San Juan de Ávila", p: "/s/san-juan-de-avila/" }, { n: "San Antonino de Florencia", p: "/s/san-antonino-de-florencia/" }],
        ...
        "6-26": [{ n: "San Josemaría Escrivá de Balaguer", p: "/s/san-josemaria-escriva-de-balaguer/" }, { n: "San Vigilio", p: "/s/san-vigilio/" }, { n: "San Deodato", p: "/s/san-deodato/" }],
        ...
        "6-29": [{ n: "San Pedro", p: "/s/san-pedro/" }, { n: "San Pablo Apóstol", p: "/s/san-pablo-apostol/" }, { n: "Santos Protomártires de Roma", p: "/s/santos-protomartires-de-roma/" }, { n: "Santa Ema", p: "/s/santa-ema/" }],
        "7-1":  [{ n: "Sangre de Cristo", p: "/s/sangre-de-cristo/" }, { n: "San Aarón", p: "/s/san-aaron/" }],
        "7-2":  [{ n: "San Bernardino Realino", p: "/s/san-bernardino-realino/" }, { n: "San Otón de Bamberg", p: "/s/san-oton-de-bamberg/" }],
        ...
        "8-8":  [{ n: "Domingo de Guzmán", p: "/s/santo-domingo-de-guzman/" }, { n: "Catorce Santos Auxiliares", p: "/s/catorce-santos-auxiliares/" }],
        "8-9":  [{ n: "Santa Teresa Benedicta de la Cruz", p: "/s/santa-teresa-benedicta-de-la-cruz/" }, { n: "San Oswaldo de Nortumbria", p: "/s/san-oswaldo-de-nortumbria/" }, { n: "San Juan de Alvernia", p: "/s/san-juan-de-alvernia/" }],
        ...
        "9-2":  [{ n: "San Emerico", p: "/s/san-emerico/" }, { n: "Santos Justo de Lyon y Viator", p: "/s/santos-justo-de-lyon-y-viator/" }, { n: "San Guillermo de Roskilde", p: "/s/san-guillermo-de-roskilde/" }],
        "9-3":  [{ n: "San Gregorio I Magno", p: "/s/san-gregorio-i-magno/" }],
        "9-4":  [{ n: "Santa Rosalía de Palermo", p: "/s/santa-rosalia-de-palermo/" }, { n: "Santa Rosa de Viterbo", p: "/s/santa-rosa-de-viterbo/" }],
        ...
        "10-10":[{ n: "San Paulino de York", p: "/s/san-paulino-de-york/" }],
        ...
        "10-30":[{ n: "San Alfonso Rodríguez", p: "/s/san-alfonso-rodriguez/" }],
        ...
        "12-10":[{ n: "Nuestra Señora de Loreto", p: "/n/nuestra-senora-de-loreto/" }, { n: "Traslación de la Santa Casa de Loreto", p: "/t/traslacion-de-la-santa-casa-de-loreto/" }],
